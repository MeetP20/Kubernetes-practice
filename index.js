...
const DB = 'mongodb://example-user:example-pass@mongo-server:27017/docker';
...
mongoose.connect(DB, {
    ...
    console.log("connection established with mongodb container");
...
smtpProtocol = nodemailer.createTransport({
    ...
    service: "gmail",
    auth: {
        user: "prajapatimeet301@gmail.com",
...
if (queryCount<15) {
    ...
    var mailOptions = {
        from: "prajapatimeet301@gmail.com",
        to: req.body.Email,
